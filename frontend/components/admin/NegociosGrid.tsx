...
export function NegociosGrid() {
  ...
  return (
    <Card>
      ...
      <CardContent>
        {loading ? (
          <div className="py-12 text-center text-sm text-muted-foreground">Cargando negocios…</div>
        ) : filtered.length === 0 ? (
          <div className="py-12 text-center text-sm text-muted-foreground">No hay negocios para mostrar.</div>
        ) : (
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">{n.num_promociones}</span>
                      </div>
                      <div className="flex justify-between">
                        <span>Avg canjes / promo:</span>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        // Conecta con tu flujo de detalle si lo tienes
                        // Por ejemplo, navegar a /admin/negocios/[id]
                      }}
                    >
