...
export function NegociosGrid() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    // --- Administrador (first) ---
    fd.append("administrador.correo", (formEl.elements.namedItem("administrador.correo") as HTMLInputElement)?.value || "");
    fd.append("administrador.telefono", (formEl.elements.namedItem("administrador.telefono") as HTMLInputElement)?.value || "");
    fd.append("administrador.nombre", (formEl.elements.namedItem("administrador.nombre") as HTMLInputElement)?.value || "");
    fd.append("administrador.apellido_paterno", (formEl.elements.namedItem("administrador.apellido_paterno") as HTMLInputElement)?.value || "");
    fd.append("administrador.apellido_materno", (formEl.elements.namedItem("administrador.apellido_materno") as HTMLInputElement)?.value || "");
    fd.append("administrador.usuario", (formEl.elements.namedItem("administrador.usuario") as HTMLInputElement)?.value || "");
    fd.append("administrador.contrasena", (formEl.elements.namedItem("administrador.contrasena") as HTMLInputElement)?.value || "");

    // --- Negocio ---
    fd.append("negocio.correo", (formEl.elements.namedItem("negocio.correo") as HTMLInputElement)?.value || "");
    fd.append("negocio.telefono", (formEl.elements.namedItem("negocio.telefono") as HTMLInputElement)?.value || "");
    fd.append("negocio.nombre", (formEl.elements.namedItem("negocio.nombre") as HTMLInputElement)?.value || "");
    fd.append("negocio.rfc", (formEl.elements.namedItem("negocio.rfc") as HTMLInputElement)?.value || "");
    fd.append("negocio.sitio_web", (formEl.elements.namedItem("negocio.sitio_web") as HTMLInputElement)?.value || "");
    fd.append("negocio.estatus", (formEl.elements.namedItem("negocio.estatus") as HTMLInputElement)?.value || "");
    fd.append("negocio.cp", (formEl.elements.namedItem("negocio.cp") as HTMLInputElement)?.value || "");
    fd.append("negocio.numero_ext", (formEl.elements.namedItem("negocio.numero_ext") as HTMLInputElement)?.value || "");
    fd.append("negocio.numero_int", (formEl.elements.namedItem("negocio.numero_int") as HTMLInputElement)?.value || "");
    fd.append("negocio.colonia", (formEl.elements.namedItem("negocio.colonia") as HTMLInputElement)?.value || "");
    fd.append("negocio.municipio", (formEl.elements.namedItem("negocio.municipio") as HTMLInputElement)?.value || "");
    fd.append("negocio.estado", (formEl.elements.namedItem("negocio.estado") as HTMLInputElement)?.value || "");
    fd.append("negocio.url_maps", (formEl.elements.namedItem("negocio.url_maps") as HTMLInputElement)?.value || "");
    ...
    const creado = (formEl.elements.namedItem("creado_por_admin") as HTMLInputElement)?.checked ? "true" : "false";
            ...
            <DialogContent className="sm:max-w-2xl glass-alt text-white border-white/20 p-0">
              ...
              <div className="max-h-[80vh] flex flex-col">
                <DialogHeader className="px-6 pt-5 pb-3 border-b border-white/10">
                  <DialogTitle className="text-white">Crear colaborador</DialogTitle>
                </DialogHeader>

                {/* Scrollable body */}
                <div className="px-6 py-4 overflow-y-auto">
                  <form id="crearColaboradorForm" onSubmit={handleSubmit} className="space-y-6">
                    {/* ADMINISTRADOR */}
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input id="administrador.correo" name="administrador.correo" type="email" required defaultValue="conimu@demo.com"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="administrador.telefono">Teléfono</Label>
                          <Input id="administrador.telefono" name="administrador.telefono" required defaultValue="55555555"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="administrador.nombre">Nombre</Label>
                          <Input id="administrador.nombre" name="administrador.nombre" required defaultValue="Ana"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="administrador.apellido_paterno">Apellido paterno</Label>
                          <Input id="administrador.apellido_paterno" name="administrador.apellido_paterno" required defaultValue="López"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="administrador.apellido_materno">Apellido materno</Label>
                          <Input id="administrador.apellido_materno" name="administrador.apellido_materno" required defaultValue="Ruiz"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="administrador.usuario">Usuario</Label>
                          <Input id="administrador.usuario" name="administrador.usuario" required defaultValue="conimux"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div className="md:col-span-2">
                          <Label htmlFor="administrador.contrasena">Contraseña</Label>
                          <Input id="administrador.contrasena" name="administrador.contrasena" type="password" required defaultValue="secreta123"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input id="negocio.correo" name="negocio.correo" type="email" required defaultValue="conimagen@demo.com"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="negocio.telefono">Teléfono</Label>
                          <Input id="negocio.telefono" name="negocio.telefono" required defaultValue="5551234567"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="negocio.nombre">Nombre</Label>
                          <Input id="negocio.nombre" name="negocio.nombre" required defaultValue="Mi Negocio SA de CV"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="negocio.rfc">RFC</Label>
                          <Input id="negocio.rfc" name="negocio.rfc" required defaultValue="XAXX010101000"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="negocio.sitio_web">Sitio web</Label>
                          <Input id="negocio.sitio_web" name="negocio.sitio_web" defaultValue="https://www.ejemplo.com"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="negocio.estatus">Estatus</Label>
                          <Input id="negocio.estatus" name="negocio.estatus" defaultValue="En revision"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="negocio.cp">CP</Label>
                          <Input id="negocio.cp" name="negocio.cp" defaultValue="01000"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="negocio.numero_ext">Número ext.</Label>
                          <Input id="negocio.numero_ext" name="negocio.numero_ext" defaultValue="5"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="negocio.numero_int">Número int.</Label>
                          <Input id="negocio.numero_int" name="negocio.numero_int" defaultValue="5"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="negocio.colonia">Colonia</Label>
                          <Input id="negocio.colonia" name="negocio.colonia" defaultValue="Centro"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="negocio.municipio">Municipio</Label>
                          <Input id="negocio.municipio" name="negocio.municipio" defaultValue="CDMX"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div>
                          <Label htmlFor="negocio.estado">Estado</Label>
                          <Input id="negocio.estado" name="negocio.estado" defaultValue="CDMX"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
                        <div className="md:col-span-2">
                          <Label htmlFor="negocio.url_maps">URL de Maps</Label>
                          <Input id="negocio.url_maps" name="negocio.url_maps" defaultValue="maps.com"
                            className="bg-white/10 border-white/20 text-white placeholder:text-white/60" />
                        </div>
